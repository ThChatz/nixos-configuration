...
borgbuckup seems to do exactly what im looking for here
also has the benefit of being decoupled from btrfs -- could make switching FSes easier in the future

https://www.borgbase.com/ -- easy to setup, pricing looks good but def not the cheapest storage
* home-manager [2/9]
